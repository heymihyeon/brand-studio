...
export const unifiedFormats: UnifiedFormat[] = [
    ...
    canvas: {
      ...
      objects: [
        ...
        },
        {
          type: 'image',
          id: 'motif',
          src: '/images/motif_Horizontal.png',
          left: 0,
          top: 0,
          width: 1200,
          height: 628,
  ...
  //banner-wide : default
  {
    id: 'banner-wide-default',
    name: 'Wide',
    category: 'Google Ads',
    dimensions: { width: 1200, height: 360 },
    templateVariant: 'default',
    formatGroup: 'banner-wide',
    canvas: {
      width: 1200,
      height: 360,
      backgroundColor: '#ffffff',
      objects: [
        {
          type: 'image',
          id: 'bg-image',
          src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=360&fit=crop',
          left: 0,
          top: 0,
          width: 1200,
          height: 360,
